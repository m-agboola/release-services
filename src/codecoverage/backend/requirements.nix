...
#
# COMMAND:
#   pypi2nix -v -C /tmp/release-services-e02fhkcs/src/codecoverage/backend/../../../tmp/pypi2nix -V 3.7 -O ../../../nix/requirements_override.nix -e vcversioner -e pytest-runner -e setuptools-scm -r requirements.txt -r requirements-dev.txt
#
...
let
  ...
  generated = self: {
    ...
    "fakeredis" = python.mkDerivation {
      name = "fakeredis-0.16.0";
      src = pkgs.fetchurl {
        url = "https://files.pythonhosted.org/packages/bd/9f/ad782b49ccbd788510961b7e64c8d825376ddfdd2251b2f20393d7c0f8c6/fakeredis-0.16.0.tar.gz";
        sha256 = "ba8a820203ba5a7a7ef62e3619318d513b87f60328c5583634df398ae4b7af00";
      };
      doCheck = commonDoCheck;
      checkPhase = "";
      installCheckPhase = "";
