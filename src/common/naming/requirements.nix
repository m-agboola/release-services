...
#
# COMMAND:
#   pypi2nix -v -C /tmp/release-services-ug4ij6ad/src/common/naming/../../../tmp/pypi2nix -V 3.7 -O ../../../nix/requirements_override.nix -e pytest-runner -e setuptools-scm -r requirements-dev.txt
#
