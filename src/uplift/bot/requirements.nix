...
#
# COMMAND:
#   pypi2nix -v -C /tmp/release-services-dykub78v/src/uplift/bot/../../../tmp/pypi2nix -V 3.7 -O ../../../nix/requirements_override.nix -E postgresql -E libffi -E openssl -E pkgconfig -E freetype.dev -e pytest-runner -e setuptools-scm -r requirements.txt -r requirements-dev.txt
#
